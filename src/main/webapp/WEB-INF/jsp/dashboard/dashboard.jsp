...
<head>
  ...
  <link rel="stylesheet" href="css/print-dashbord.css">
</head>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    ...
                    <span class="font-weight-bold">Seja Bem-vindo(a) ao Jogo Loteria. Boa Sorte!</span>
                  </div>
                </a>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle" style="color: #20c9a6;"></i> Ganhou
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-danger"></i> Perdeu
                    </span>
                  </div>
                </div>
              </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto no-print">
            <span>Copyright &copy; Desenvolvimento Web com Java</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
